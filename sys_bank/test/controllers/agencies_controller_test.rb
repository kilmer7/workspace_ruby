...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { adress: @agency.adress, num_agency: @agency.num_agency } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { adress: @agency.adress, num_agency: @agency.num_agency } }
